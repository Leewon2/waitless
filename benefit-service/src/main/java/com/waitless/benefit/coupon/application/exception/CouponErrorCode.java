...
public enum CouponErrorCode implements ErrorCode {
	...
	COUPONHISTORY_NOT_FOUND("COUPON_003", "해당 쿠폰발급내역을 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
	COUPONHISTORY_UNAUTHORIZED("COUPON_004", "해당 쿠폰발급내역에 대한 권한이 없습니다.", HttpStatus.UNAUTHORIZED);
