...
public class UserController {
	...
	// 유저 수정
	@PatchMapping("/{id}")
	public ResponseEntity<SingleResponse<UserResponseDto>> updateUser(@PathVariable Long id, @RequestBody Map<String, Object> updates) {
		UserResponseDto userResponseDto = userService.modifyUser(id, updates);
